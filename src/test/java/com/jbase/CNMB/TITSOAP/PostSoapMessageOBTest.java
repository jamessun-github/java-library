...
public class PostSoapMessageOBTest {
    ...
    public void testSoap() {
        ...
        String sUrl = "http://127.0.0.1:7800/esbws?wsdl";
        String sContentType = "text/xml; charset=utf-8";
        String timeoutStr = "60";
        String sRetry = "3";
        String soapRequestData = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?> <soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:chb=\"http://test.com/CHBTWS\">   <soapenv:Header/>   <soapenv:Body>      <chb:callOfs>           <OfsRequest>ENQUIRY.SELECT,,ITFIB.01//HK0010256,ENQ.ITF.LOAN.BAL,ACCOUNT:EQ=256500001201</OfsRequest>      </chb:callOfs>   </soapenv:Body></soapenv:Envelope>";
        //String soapRequestData = "  <soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:chb=\"http://test.com/CHBTWS\">   <soapenv:Header/>   <soapenv:Body>      <chb:callOfs>           <OfsRequest>ENQUIRY.SELECT,,ITFIB.01//HK0010256,ENQ.ITF.LOAN.BAL,ACCOUNT:EQ=256500001201</OfsRequest>      </chb:callOfs>   </soapenv:Body></soapenv:Envelope>";
